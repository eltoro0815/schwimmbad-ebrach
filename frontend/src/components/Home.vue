...
export default {
    ...
    methods: {
                 ...
                 Notification.requestPermission()
                    .then(result => {
                        ...
                        if (result === 'granted') {
                            ...
                            .then(sub => {
                                console.log('Home.vue: subscription created on the client', sub);
                                this.subscription = sub

                                // get new (or existing user) from backend
                                return axios.post('api/user', {username: localStorage.getItem('username')})
                            })
                            .then(({data}) => {
                                const { user } = data
        ...
        subscribe(swreg) {
            console.log('Home.vue: create new subscription for this browser on this device');
